...
******************************************************************************/
  ...
  function create_node ({
    ...
    const duplicate_instance = find_any_duplicate_entry(base_path, instance_path)
    const navigate_button_html = duplicate_instance ? '<span class="navigate-to-hub clickable">^</span>' : ''
...
******************************************************************************/
  ...
  ******************************************************************************/
  ...
  function find_any_duplicate_entry (target_base_path, exclude_instance_path) {
    for (const node of view) {
      if (node.instance_path === exclude_instance_path) continue
      if (node.base_path === target_base_path) return node.instance_path
    }
    return null
  }
