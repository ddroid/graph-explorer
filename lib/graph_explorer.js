...
ESSAGE HANDLING
  ...
  ******************************************************************************/
  function onmessage ({ type, data }) {
    ...
    function handle_db_response (data) {
      const { id, result } = data
      db.handle_response(id, result)
    }
  ...
  function create_db () {
    // Pending requests map to store [resolve || reject] callbacks
