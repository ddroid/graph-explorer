...
******************************************************************************/
  ...
  function calculate_pipe_trail ({
    ...
    return {
      children_pipe_trail,
      pipe_trail,
      is_hub_on_top: final_is_hub_on_top
    }
  }
...
******************************************************************************/
  ...
  function build_view_recursive ({
    ...
    // Use extracted pipe logic
    const { children_pipe_trail, pipe_trail, is_hub_on_top } = calculate_pipe_trail({
      depth,
      is_hub,
      is_last_sub,
      is_first_hub,
...
******************************************************************************/
  ...
  function build_search_view_recursive ({
    ...
    const hub_results = should_expand_hubs ? (entry.hubs || []).map((hub_path, i, arr) => {
      const hub_result = build_search_view_recursive({
        query,
        base_path: hub_path,
        parent_instance_path: instance_path,
        parent_base_path: base_path,
