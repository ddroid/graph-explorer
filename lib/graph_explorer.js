...
******************************************************************************/
  ...
  function on_entries ({ data }) {
    ...
    if (all_entries[root_path]) {
      ...
      // Initialize root tracking when entries are first loaded
...
******************************************************************************/
  ...
  ******************************************************************************/
  ...
  function add_instance_to_view_tracking (base_path, instance_path) {
    ...
    if (!view_order_tracking[base_path].includes(instance_path)) view_order_tracking[base_path].push(instance_path)
  }
